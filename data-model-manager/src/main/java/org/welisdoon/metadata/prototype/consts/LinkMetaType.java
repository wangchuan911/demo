...
public enum LinkMetaType implements IMetaType {
    ...
    SqlToJoin(3010, "对象对象关联数据库的表", ObjToDataBase),
    SqlToSelect(3011, "对象关联的数据库字段", ObjToDataBase),
    SqlToJoinOfMultiDataRel(3012, "对象对象关联数据库的表(多对一)", SqlToJoin),
    SqlToJoinOfWeakRel(3013, "对象对象关联数据库的表(非强制关联)", SqlToJoin),
    SqlToJoinOfStrongRel(3014, "对象对象关联数据库的表(强制关联)", SqlToJoin),
