...
public class NodeServiceAspect {
    ...
    @Pointcut("execution( void *..*.start(org.welisdoon.flow.module.flow.entity.Stream)) && target(org.welisdoon.flow.module.template.service.AbstractNode)")
    public void start() {

    }

    @Pointcut("execution( void *..*.finish(org.welisdoon.flow.module.flow.entity.Stream)) && target(org.welisdoon.flow.module.template.service.AbstractNode)")
    public void finish() {
    ...
    FlowEvent getFlowEvent(Stream stream) {
        return AbstractNode.getFunctionObject(stream.getFlow().getFunctionId());
    }
}
